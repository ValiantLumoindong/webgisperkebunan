...
<main id="main-container">
    ...
    <div class="content">
        <nav class="breadcrumb push bg-body-extra-light rounded-pill px-4 py-2">
            <a class="breadcrumb-item" href="{{ route('kebun.home') }}">Kebun</a>
                        ...
                        @forelse ($kebun as $tampilkebun)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('kebun.edit', $tampilkebun->id) }}"  class="btn btn-sm btn-secondary" data-bs-toggle="tooltip" title="Edit Kebun">
                                    ...
                                    <form action="{{ route('kebun.hapus.admin', $tampilkebun->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="block block-rounded shadow-none mb-0">
                                                        <div class="block-header block-header-default">
                                                            <h3 class="block-title">Hapus Data {{ $tampilkebun->nama }}?</h3>
