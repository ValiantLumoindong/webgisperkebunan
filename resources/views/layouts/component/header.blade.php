          ...
          <div class="js-sidebar-scroll">
            ...
            <div class="content-side content-side-full">
              <ul class="nav-main">
                ...
                <li class="nav-main-heading">Jenis Kebun</li>
                <li class="nav-main-item">
                  <a class="nav-main-link" href="{{ route('jenis_kebun.home') }}">
                    <i class="nav-main-link-icon fa fa-book "></i>
                    <span class="nav-main-link-name">Jenis Kebun</span>
                  </a>
                </li> 
                <li class="nav-main-heading">Kebun</li>
                <li class="nav-main-item">
                  <a class="nav-main-link" href="{{ route('kebun.home') }}">
                    <i class="nav-main-link-icon fa fa-book "></i>
                    <span class="nav-main-link-name">Kebun</span>
                  </a>
                </li> 
                <li class="nav-main-heading">Pengaturan Zona Kebun</li>
                <li class="nav-main-item">
                  <a class="nav-main-link" href="{{ route('zonasi.index') }}">
                    <i class="nav-main-link-icon fa fa-book "></i>
                    <span class="nav-main-link-name">Zonasi Kebun</span>
                  </a>
                </li>                                                
              </ul>
            </div>
